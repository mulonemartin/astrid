...
from astrid.core.comp import urlunsplit


def urlparts(parts=None, scheme=None, netloc=None, path=None,
             query=None, fragment=None):
    """ Factory function for :py:class:`~astrid.core.url.UrlParts` that
        create an instance :py:class:`~astrid.core.url.UrlParts` with
        partial content.
