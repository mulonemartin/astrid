...
from astrid.captcha.comp import Draw
from astrid.captcha.comp import Image
from astrid.captcha.comp import ImageFilter
from astrid.captcha.comp import getrgb
from astrid.captcha.comp import truetype
from astrid.captcha.comp import xrange
...
def curve(color='#5C87B2', width=4, number=6):
    from astrid.captcha.bezier import make_bezier
